...
impl<W, P> HasTier for crate::proofs::logic_prelude::Exists<W, P> {
    const TIER: Tier = Tier::T2Primitive;
}
...
impl CompareAbsent for crate::proofs::logic_prelude::Void {
    const REASON: &'static str = "Uninhabited type cannot be compared (no values exist)";
}

impl<W, P> CompareAbsent for crate::proofs::logic_prelude::Exists<W, P> {
...
impl<W, P> GroundsTo<t1::Existence> for crate::proofs::logic_prelude::Exists<W, P> {}
...
#[inline]
pub fn exhaustive_void<R>(void: crate::proofs::logic_prelude::Void) -> R {
    match void {}
}
...
pub mod vigilance_tiers {
    use super::*;
    use crate::proofs::theorems::vigilance::*;
