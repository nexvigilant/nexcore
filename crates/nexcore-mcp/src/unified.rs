...
async fn dispatch_inner(
    ...
    match command {
        ...
        "implicit_add_correction" => typed(params, tools::brain::implicit_add_correction),
        ...
        // ====================================================================
        // DNA-ML Pipeline (3) — DNA-encoded feature augmentation + random forest
        // ====================================================================
        "dna_ml_encode" => typed(params, tools::dna_ml::dna_ml_encode),
        "dna_ml_similarity" => typed(params, tools::dna_ml::dna_ml_similarity),
        ...
        // ── Pharma company entity tools (profile, signals, pipeline, boxed warnings) ──
        "pharma_company_profile" => typed(params, tools::pharma_tools::pharma_company_profile),
        "pharma_signal_portfolio" => typed(params, tools::pharma_tools::pharma_signal_portfolio),
        "pharma_pipeline" => typed(params, tools::pharma_tools::pharma_pipeline),
        "pharma_boxed_warnings" => typed(params, tools::pharma_tools::pharma_boxed_warnings),
...
fn unified_catalog_data() -> serde_json::Value {
    serde_json::json!({
        "categories": {
            ...
            "brain": ["brain_session_create", "brain_session_load", "brain_sessions_list", "brain_artifact_save", "brain_artifact_resolve", "brain_artifact_get", "brain_artifact_diff", "code_tracker_track", "code_tracker_changed", "code_tracker_original", "implicit_get", "implicit_set", "implicit_stats", "implicit_find_corrections", "implicit_add_correction", "implicit_patterns_by_grounding", "implicit_patterns_by_relevance", "brain_recovery_check", "brain_recovery_repair", "brain_recovery_rebuild_index", "brain_recovery_auto", "brain_coordination_acquire", "brain_coordination_release", "brain_coordination_status", "brain_verify_engrams"],
            ...
            "pharma_company": ["pharma_company_profile", "pharma_signal_portfolio", "pharma_pipeline", "pharma_boxed_warnings"],
