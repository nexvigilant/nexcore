...
use crate::{OutputContent, SkillContext, SkillMetadata, SkillOutput, SkillResult, Trigger};
...
pub trait Skill: Send + Sync {
    ...
    fn validate(&self, _ctx: &SkillContext) -> Result<(), crate::SkillError> {
        Ok(())
    }
...
impl Skill for SkillChain {
    ...
    fn metadata(&self) -> SkillMetadata {
        SkillMetadata {
            ...
            compliance: crate::ComplianceLevel::Bronze,
            mcp_tools: Vec::new(),
            paired_agent: None,
            requires: vec![
