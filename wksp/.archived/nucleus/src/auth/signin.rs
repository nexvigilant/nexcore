...
use crate::auth::{use_auth, server_sign_in};
...
pub fn SignInPage() -> impl IntoView {
    ...
    let on_submit = move |ev: leptos::ev::SubmitEvent| {
        ...
        leptos::task::spawn_local(async move {
            match server_sign_in(email_val, password_val).await {
                Ok(data) => {
        ...
        <div class="flex min-h-screen items-center justify-center px-4">
            <div class="w-full max-w-md space-y-8">
                <div class="text-center">
                    ...
                    <p class="mt-2 text-slate-400">"Welcome back to Nucleus"</p>
                </div>
                ...
                <form class="space-y-6" on:submit=on_submit>
                    ...
                    <div class="flex items-center justify-between">
                        <a href="/reset-password" class="text-sm text-cyan-400 hover:text-cyan-300">"Forgot password?"</a>
                    </div>
                    <button
                        type="submit"
                ...
                <p class="text-center text-sm text-slate-400">
                    ...
                    <a href="/signup" class="text-cyan-400 hover:text-cyan-300 font-medium">"Sign up"</a>
                </p>
            </div>
        </div>
    }
