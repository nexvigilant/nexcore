...
pub fn transfer_mappings() -> Vec<TransferMapping> {
    vec![
        ...
        TransferMapping {
            ...
            domain: "PV",
            analog: "Reporting pathway (MAH -> NRA)",
            confidence: 0.88,
        },
        TransferMapping {
            cloud_type: "NetworkLink",
            domain: "Biology",
            analog: "Axon / neural pathway",
            confidence: 0.90,
        },
        TransferMapping {
            cloud_type: "NetworkLink",
            domain: "Economics",
            analog: "Trade route / supply chain link",
            confidence: 0.85,
        },
        // T2-P: IsolationBoundary
        TransferMapping {
            cloud_type: "IsolationBoundary",
            domain: "PV",
            analog: "Regulatory jurisdiction boundary",
            confidence: 0.85,
        },
        TransferMapping {
            cloud_type: "IsolationBoundary",
            domain: "Biology",
            analog: "Cell membrane / blood-brain barrier",
            confidence: 0.92,
        },
        TransferMapping {
            cloud_type: "IsolationBoundary",
            domain: "Economics",
            analog: "Market segmentation / trade barrier",
            confidence: 0.80,
        },
        // T2-P: Permission
        TransferMapping {
            cloud_type: "Permission",
            domain: "PV",
            analog: "Role-based case access (QPPV, reviewer)",
            confidence: 0.88,
        },
        TransferMapping {
            cloud_type: "Permission",
            domain: "Biology",
            analog: "Enzyme-substrate specificity / receptor lock-key",
            confidence: 0.78,
        },
        TransferMapping {
            cloud_type: "Permission",
            domain: "Economics",
            analog: "License / regulatory approval to operate",
            confidence: 0.85,
        },
        // T2-P: Metering
        TransferMapping {
            cloud_type: "Metering",
            domain: "PV",
            analog: "Case processing rate / volume tracking",
            confidence: 0.88,
        },
        TransferMapping {
            cloud_type: "Metering",
            domain: "Biology",
            analog: "Metabolic rate / caloric expenditure",
            confidence: 0.82,
        },
        TransferMapping {
            cloud_type: "Metering",
            domain: "Economics",
            analog: "Utility meter / consumption billing",
            confidence: 0.92,
        },
        // T2-P: Replication
        TransferMapping {
            cloud_type: "Replication",
            domain: "PV",
            analog: "Data backup / multi-site case archive",
            confidence: 0.85,
        },
        TransferMapping {
            cloud_type: "Replication",
            domain: "Biology",
            analog: "DNA replication / cell division",
            confidence: 0.95,
        },
        TransferMapping {
            cloud_type: "Replication",
            domain: "Economics",
            analog: "Portfolio diversification / multi-site",
            confidence: 0.78,
        },
        // T2-P: Routing
        TransferMapping {
            cloud_type: "Routing",
            domain: "PV",
            analog: "Case triage / signal routing to assessor",
            confidence: 0.88,
        },
        TransferMapping {
            cloud_type: "Routing",
            domain: "Biology",
            analog: "Chemotaxis / axon guidance",
            confidence: 0.82,
        },
        TransferMapping {
            cloud_type: "Routing",
            domain: "Economics",
            analog: "Order routing / market making",
            confidence: 0.85,
        },
        // T2-P: Elasticity
        TransferMapping {
            cloud_type: "Elasticity",
            domain: "PV",
            analog: "Surge staffing for safety report influx",
            confidence: 0.82,
        },
        TransferMapping {
            cloud_type: "Elasticity",
            domain: "Biology",
            analog: "Tissue growth / wound healing response",
            confidence: 0.85,
        },
        TransferMapping {
            cloud_type: "Elasticity",
            domain: "Economics",
            analog: "Workforce scaling / elastic labor market",
            confidence: 0.88,
        },
    ]
}
...
mod tests {
    ...
    fn test_three_domains_per_t2p() {
        ...
        for type_name in &t2p_types {
            let transfers = transfers_for_type(type_name);
            assert_eq!(
                transfers.len(),
                3,
                "T2-P type {} should have 3 domain mappings, got {}",
                type_name,
                transfers.len()
            );
        }
