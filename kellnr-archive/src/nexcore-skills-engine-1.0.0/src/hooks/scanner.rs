...
//!
//! Recursively scans directories to find:
//! - Files violating placement policies
//! - Stale files exceeding age thresholds
//! - Security-sensitive files in wrong locations
...
/// Directories to skip during scanning (performance and relevance)
const SKIP_DIRS: &[&str] = &[
    ".git",
    "node_modules",
    ".venv",
...
impl ScanOptions {
    /// Create new scan options with default depth of 3
    pub fn new() -> Self {
        Self {
            max_depth: 3,
    ...
    pub fn skip(mut self, dirs: Vec<String>) -> Self {
        self.skip_dirs = dirs;
        self
    }
}
