...
pub fn tool_registry() -> Vec<ToolMeta> {
    vec![
        ...
        // ml_pipeline (5 tools) — autonomous PV signal detection
        ToolMeta {
            name: "ml_feature_extract",
            category: "ml_pipeline",
            highway_class: 1,
            outputs: &["feature_vector", "prr", "ror", "ic", "ebgm"],
            inputs: &["drug", "event", "a", "b", "c", "d"],
            depends_on: &[],
            alternatives: &[],
        },
        ToolMeta {
            ...
            category: "ml_pipeline",
            highway_class: 1,
            outputs: &["model_id", "accuracy", "auc", "feature_importance"],
            inputs: &["samples"],
            depends_on: &["ml_feature_extract"],
            alternatives: &[],
        },
        ToolMeta {
            name: "ml_predict",
            category: "ml_pipeline",
            highway_class: 1,
            outputs: &["predictions", "signal_probability"],
            inputs: &["model_id", "samples"],
            depends_on: &["ml_train"],
            alternatives: &[],
        },
        ToolMeta {
            ...
            category: "ml_pipeline",
            highway_class: 1,
            outputs: &["auc", "precision", "recall", "f1", "confusion_matrix"],
            inputs: &["model_id", "test_samples"],
            depends_on: &["ml_train"],
            alternatives: &[],
        },
        ToolMeta {
            ...
            category: "ml_pipeline",
            highway_class: 1,
            outputs: &["train_metrics", "test_metrics", "predictions"],
            inputs: &["data", "labels"],
            depends_on: &[],
            alternatives: &["ml_train"],
        },
