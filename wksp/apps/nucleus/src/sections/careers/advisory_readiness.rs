//! Advisory board readiness assessment — evaluate readiness to serve on PV advisory boards
...
pub fn AdvisoryReadinessPage() -> impl IntoView {
    let ratings: Vec<(RwSignal<u8>, &'static str, &'static str)> = vec![
        (RwSignal::new(0), "AR01", "Strategic Thinking — ability to contribute long-term PV strategy"),
        (RwSignal::new(0), "AR02", "Industry Knowledge — depth of pharma/biotech landscape understanding"),
        (RwSignal::new(0), "AR03", "Governance Experience — familiarity with board governance structures"),
        (RwSignal::new(0), "AR04", "Network Quality — strength and relevance of professional network"),
        (RwSignal::new(0), "AR05", "Communication — ability to articulate complex safety concepts clearly"),
        (RwSignal::new(0), "AR06", "Financial Literacy — understanding of PV budget, ROI, and resource allocation"),
        (RwSignal::new(0), "AR07", "Ethics and Integrity — track record of ethical decision-making in safety"),
        (RwSignal::new(0), "AR08", "Time Commitment — availability and willingness to dedicate board time"),
    ];
    ...
    view! {
        <div class="mx-auto max-w-4xl px-4 py-8">
            <h1 class="text-3xl font-bold text-white font-mono uppercase tracking-tight">"Advisory Board Readiness"</h1>
            <p class="mt-2 text-slate-400">"Evaluate your readiness to serve on pharmacovigilance advisory boards (1-5)."</p>
