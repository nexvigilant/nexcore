    ...
    F: Fn(&str, &PrimitiveComposition) -> serde_json::Value,
{
    ...
    dispatch_lex! {
        ...
        // Cloud Computing Taxonomy (35 types — nexcloud)
        // T1 (Cloud-prefixed to avoid collision with vigilance types)
        "CloudIdentity" => nexcloud::primitives::Identity,
        "CloudThreshold" => nexcloud::primitives::Threshold,
        "CloudFeedbackLoop" => nexcloud::primitives::FeedbackLoop,
        "CloudIdempotency" => nexcloud::primitives::Idempotency,
        "CloudImmutability" => nexcloud::primitives::Immutability,
        "CloudConvergence" => nexcloud::primitives::Convergence,
        // T2-P
        "Compute" => nexcloud::primitives::Compute,
        "Storage" => nexcloud::primitives::Storage,
        "NetworkLink" => nexcloud::primitives::NetworkLink,
        "IsolationBoundary" => nexcloud::primitives::IsolationBoundary,
        "CloudPermission" => nexcloud::primitives::Permission,
        "ResourcePool" => nexcloud::primitives::ResourcePool,
        "Metering" => nexcloud::primitives::Metering,
        "Replication" => nexcloud::primitives::Replication,
        "CloudRouting" => nexcloud::primitives::Routing,
        "CloudLease" => nexcloud::primitives::Lease,
        "CloudEncryption" => nexcloud::primitives::Encryption,
        "CloudQueue" => nexcloud::primitives::Queue,
        "CloudHealthCheck" => nexcloud::primitives::HealthCheck,
        "Elasticity" => nexcloud::primitives::Elasticity,
        // T2-C Composites
        "VirtualMachine" => nexcloud::composites::VirtualMachine,
        "LoadBalancer" => nexcloud::composites::LoadBalancer,
        "AutoScaling" => nexcloud::composites::AutoScaling,
        "CloudIam" => nexcloud::composites::Iam,
        "EventualConsistency" => nexcloud::composites::EventualConsistency,
        "Tenancy" => nexcloud::composites::Tenancy,
        "PayPerUse" => nexcloud::composites::PayPerUse,
        "ReservedCapacity" => nexcloud::composites::ReservedCapacity,
        "SpotPricing" => nexcloud::composites::SpotPricing,
        "SecretsManagement" => nexcloud::composites::SecretsManagement,
        // T3 Domain-Specific
        "Container" => nexcloud::service_models::Container,
        "Iaas" => nexcloud::service_models::Iaas,
        "Paas" => nexcloud::service_models::Paas,
        "Saas" => nexcloud::service_models::Saas,
        "Serverless" => nexcloud::service_models::Serverless,
    }
