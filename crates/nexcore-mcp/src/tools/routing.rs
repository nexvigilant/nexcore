...
pub fn tool_registry() -> Vec<ToolMeta> {
    vec![
        ...
        ToolMeta {
            ...
            inputs: &["frequency", "severity", "detectability"],
            depends_on: &[],
            alternatives: &[],
        },
        ToolMeta {
            ...
            category: "vigilance",
            highway_class: 2,
            outputs: &["safety_distance"],
            inputs: &["observed", "threshold"],
            depends_on: &[],
            alternatives: &[],
        },
        ...
        ToolMeta {
            ...
            inputs: &["quality", "theme", "cvd_mode", "explorer", "layout", "post_processing"],
            depends_on: &[],
            alternatives: &[],
        },
        ToolMeta {
        ...
        ToolMeta {
            ...
            inputs: &["explorer", "quality", "theme", "cvd_mode", "layout", "post_processing"],
            depends_on: &[],
            alternatives: &[],
        },
    ]
...
pub fn routing_rules() -> Vec<RoutingRule> {
    vec![
        ...
        RoutingRule {
            patterns: &["fda guidance", "fda draft", "guidance document", "fda recommendation"],
